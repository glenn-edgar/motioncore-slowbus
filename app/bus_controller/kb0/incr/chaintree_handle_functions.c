...
const main_function_t ct_j5te5xxi_main_functions[] = {
    cfl_null_main_fn,
...
const one_shot_function_t ct_j5te5xxi_one_shot_functions[] = {
...
const boolean_function_t ct_j5te5xxi_boolean_functions[] = {
    cfl_null_boolean_fn,
...
const uint16_t ct_j5te5xxi_main_function_usage_count[6] = {
    0,  /* CFL_NULL */
    7,  /* CFL_COLUMN_MAIN */
    7,  /* CFL_DISABLE */
...
const char *ct_j5te5xxi_main_function_names[6] = {
    "CFL_NULL",
    "CFL_COLUMN_MAIN",
    "CFL_DISABLE",
    "CFL_GATE_NODE_MAIN",
...
const char *ct_j5te5xxi_one_shot_function_names[15] = {
    "CFL_NULL",
    "ADC_READ",
    "APP_ECHO",
    "APP_ECHO_TO",
...
const char *ct_j5te5xxi_boolean_function_names[4] = {
    "CFL_NULL",
    "CFL_COLUMN_NULL",
    "CFL_GATE_NODE_NULL",
    "CFL_WAIT_FOR_EVENT",
